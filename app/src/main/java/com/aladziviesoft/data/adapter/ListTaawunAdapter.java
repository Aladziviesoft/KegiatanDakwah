...
import com.aladziviesoft.data.UpdateTaawunActivity;
...
import static com.aladziviesoft.data.utils.AppConf.URL_DELETE_TAAWUN;
                ...
                builder.setItems(item, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            case 0:
                                item[0] = "Update";
                                intent = new Intent(context, UpdateTaawunActivity.class);
                            ...
                            case 1:
                                ...
                                // set title dialog
                                alertDialogBuilder.setTitle("Yakin ingin menghapus taawun Via : "+arrayList.get(i).getNama()+" ?");
